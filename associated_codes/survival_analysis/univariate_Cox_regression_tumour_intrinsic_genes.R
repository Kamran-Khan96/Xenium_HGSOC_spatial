...
merged_tma_adjusted <- read_csv("Figure 2/all_tumour_merged_tma5_6_combat_adjusted_log2_counts.csv")
...
hr_genes <- c("CTPS2", "IGF1R", "MECOM", "MSH2", "MSH6", "NOTCH3", "OAS1", "RNF43", "TFB1M", "ADA", "DLK1", "RBPJ", "SOGA1", 
